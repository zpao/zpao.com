...
Today [I landed a patch](https://hg.mozilla.org/mozilla-central/rev/55b6bc4c0b92) for [bug 551285](https://bugzilla.mozilla.org/show_bug.cgi?id=551285), which removes support for certain parts of sessions created in Firefox 2.0 and 3.0. _This means that if you upgrade directly from 2.0 or 3.0 to Firefox.next (currently 3.7), you will lose some session data._
