...
I'm only a couple months late with this... Hot on the heels of the [announcement that CoPress was shutting down](https://www.copress.org/2010/02/16/copress-is-closing-down-operations/), Max Cutler announced the [end of the Courant News project](https://www.maxcutler.com/2010/02/21/courant-no-longer). His post is a good read, and his blog in general has some great insight into the technology behind Courant. If you're at all interested in the future of online journalism, I highly suggest it. Since I have yet to blog about [Courant News](https://www.courantnews.com/), I feel like I must, so here's the story.

Courant News was an online newspaper project started in the fall of 2008. It was started by [Max Cutler](https://www.maxcutler.com/), [Robert Baskin](https://rsbaskin.com/), and myself out of our frustration with existing college newspaper technologies. Combined, we had ~8 years of working on college newspaper websites. Max and Rob both worked at the [Yale Daily News](https://www.yaledailynews.com/) and I worked for The Carnegie Pulse (now dead and without a domain). We both worked on custom built PHP back-ends. Robert had helped write the YDN one, while I inherited TCPulse's (and had been wanting to rewrite it for years). Both worked, but were a bit rigid for the needs of an online newspaper.

We started this project and settled on [Django](https://www.djangoproject.com/) as a technology choice. I was a Rails guy, while Max was the Django advocate. We chose Django because of it's journalism roots, my admission that I was going to have less time, and the fact that this really was Max's project. After I got to play with Django, I think it was the right choice for the project. The ability to have separate "apps" was pretty awesome. And the built in admin app (which I thought was dumb at first) turned out to be pretty essential. All-in-all I have a lot of respect for [DJ Ango](https://www.youtube.com/watch?v=PLUS00QrYWw), and as the RailsEnvy guys said, "If it wasn’t for Rails I’d probably be programming Django right now."
