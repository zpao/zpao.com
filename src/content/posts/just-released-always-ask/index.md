...
So this extension is pretty simple. It's currently available in English (en-US) but if you'd like to see it in your language, feel free to [help out on Babelzilla](https://www.babelzilla.org/index.php?option=com_wts&extension=5271). Code is available [on Github](https://github.com/zpao/alwaysAsk) (thanks to hg-git).
