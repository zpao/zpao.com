...
Last week [bug 354894](https://bugzilla.mozilla.org/show_bug.cgi?id=354894) [landed](https://hg.mozilla.org/mozilla-central/rev/cd25ab8c2f30) to, surprisingly, little fanfare. It’s a big deal though (more so on Windows & Linux).
...
Well, no longer. Nils Maier (co-author of [DownThemAll](https://www.downthemall.net/)) finally got fed up with this problem & decided to do something about it. This is the first “major” piece of code he’s contributed, so a round of applause.
